...
<div class="bg-white dark:bg-gray-800 flex relative z-20 items-center overflow-hidden">
    <div class="container mx-auto px-6 flex flex-col sm:flex-row relative py-16">
        <div class="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20 mb-8 sm:mb-0">
            <span class="w-20 h-2 bg-gray-800 dark:bg-white mb-12"></span>
            <h1 class="font-bebas-neue uppercase text-4xl sm:text-6xl md:text-8xl font-black flex flex-col leading-none dark:text-white text-gray-800">
                Be on
            ...
            <div class="flex mt-8">
                <a href="#" class="uppercase py-2 px-4 rounded-lg bg-black border-2 border-transparent text-white text-md mr-4 hover:bg-gray-800">
                    Get started
                </a>
                <a href="#" class="uppercase py-2 px-4 rounded-lg bg-transparent border-2 border-black text-black dark:text-white hover:bg-gray-800 hover:text-white text-md">
                    Read more
                </a>
            </div>
        </div>
    ...
    <section class="container mx-auto px-5 md:px-0 py-10 md:py-20 mt-8 md:mt-28">
    <section class="flex flex-col lg:flex-row items-center justify-between relative transform duration-500 hover:shadow-2xl cursor-pointer hover:-translate-y-1 ">
        <img class="w-full md:w-full md:max-w-none h-72 md:h-96 object-cover" src="storage/images/mouton1.jpg" alt="">
        <div class="bg-white p-6 md:p-12 lg:max-w-lg w-full md:max-w-none">
            <div class="flex flex-col md:flex-row items-center justify-between mb-4 md:mb-6">
                <p class="text-sm md:text-base font-bold">Product Review</p>
                <p class="text-gray-400 text-sm md:text-base mt-2 md:mt-0">17th March, 2021</p>
            </div>
            <h2 class="text-2xl md:text-3xl font-semibold mt-0 md:mt-6">Coffee From Heaven</h2>
            ...
            <button class="mt-2 md:mt-4 p-3 px-5 bg-black text-white font-bold text-sm hover:bg-gray-800">Read More</button>
        </div>
    </section>
</section>
    ...
    <div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
        ...
        <div class="mt-20 grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
            ...
            <div class="rounded overflow-hidden shadow-lg">
                ...
                <div class="relative">
                    ...
                    <a href="!#">
                        <div
                            class="text-sm absolute top-0 right-0 bg-black px-4 text-white rounded-full h-16 w-16 flex flex-col items-center justify-center mt-3 mr-3 hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
