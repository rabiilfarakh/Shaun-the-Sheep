        ...
        <div class="w-full p-8 lg:w-1/2">
            ...
            <form @submit.prevent="register">
                <div class="mt-4">
                    ...
                    <input v-model="user.name" class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="text" />
                </div>
                <div class="mt-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2">Email Address</label>
                    <input v-model="user.email" class="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" />
                </div>
                <div class="mt-4">
                ...
                <div class="mt-2">
                    Client <input value="client" class="form-radio h-4 w-4 text-indigo-600" v-model="user.role" type="radio" name="role">
