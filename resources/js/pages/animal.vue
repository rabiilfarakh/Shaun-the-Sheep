    ...
    <div class="w-auto px-24 justify-center relative mt-8">
      <div class=" w-auto px-24 justify-center relative">
        ...
        <div class="flex flex-col space-y-4">
          <div v-for="com in blog.comment" class="bg-white p-4 rounded-lg shadow-md">
            <h3 class="text-lg font-bold">nameUser</h3>
            <p class="text-gray-700 text-sm mb-2">{{ com.created_at }}</p>
            <p class="text-gray-700">{{ com.contenu }}</p>
          </div>
