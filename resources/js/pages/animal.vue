              ...
              <div class="flex items-center gap-2">
                ...
                <template v-for="n in 5">
                  ...
                  >
                    ...
                    <button @click="like" class="flex items-center text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:text-blue-500">
                    ...
                    <button @click="dislike" class="flex items-center text-black font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline hover:text-blue-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
