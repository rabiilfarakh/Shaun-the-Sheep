        ...
        <div v-else id="container" class="p-20 sm:p-16 md:p-20 lg:p-24 xl:p-20 w-auto flex flex-col md:flex-row px-4 sm:px-8 md:px-24 lg:px-24 xl:px-24 relative">
          ...
          <div class="w-full sm:w-[70%] md:w-[60%] lg:w-[50%]">
            ...
            <div id="social" class="flex flex-wrap justify-start items-center gap-4">
              ...
              <!-- Boutons like et dislike avec icônes -->
              <div class="flex items-center gap-2">
                <button @click="like" class="flex items-center bg-green-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"/>
                  </svg>
                  Like
                </button>
                <button @click="dislike" class="flex items-center bg-red-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
